...
export class ShapeCombobox implements Component {
    ...
    private selectedOption: View | null = null;

    onchange?: (selectedOption: View | null) => void;
    ...
    constructor(views: View[]) {
        ...
        this.header.addEventListener("click", () => {
            if (this.list.style.display === "block") {
                ...
                const handleClickOutside = (e: MouseEvent) => {
                    if (!this.container.contains(e.target as Node) && e.target !== this.list) {
        ...
        views.forEach((option) => {
            ...
            const canvas = document.createElement('canvas-shape-element') as CanvasShapeElement
    ...
    private selectOption(option: View): void {

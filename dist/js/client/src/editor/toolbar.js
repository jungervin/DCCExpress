define(["require", "exports"], function (require, exports) {
    ...
    class Toolbar extends HTMLElement {
        constructor() {
            ...
            super();
            this._tasks = false;
            this._taskButtonsEnabled = false;
            this._debugButtonEnabled = false;
            this._consoleButtonEnabled = false;
            this._programmerButtonEnabled = false;
        ...
        `;
            ...
            this.btnTasks = this.shadowRoot.getElementById("btnTasks");
            this.btnTaskStartAll = this.shadowRoot.getElementById("btnTaskStartAll");
            this.btnTaskStopAll = this.shadowRoot.getElementById("btnTaskStopAll");
            this.btnTaskResumeAll = this.shadowRoot.getElementById("btnTaskResumeAll");
            this.btnTaskFinishAll = this.shadowRoot.getElementById("btnTaskFinishAll");
            this.btnTaskProperties = this.shadowRoot.getElementById("btnTaskProperties");
            ...
            this.btnDebug = (_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.getElementById("btnDebug");
            this.btnConsole = (_c = this.shadowRoot) === null || _c === void 0 ? void 0 : _c.getElementById("btnConsole");
            this.btnProgrammer = (_d = this.shadowRoot) === null || _d === void 0 ? void 0 : _d.getElementById("btnProgrammer");
        ...
        get taskButtonsEnabled() {
            return this._taskButtonsEnabled;
        }
        set taskButtonsEnabled(v) {
        ...
        get programmerButtonEnabled() {
            return this._programmerButtonEnabled;
        }
        set programmerButtonEnabled(v) {

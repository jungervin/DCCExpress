...
define(["require", "exports", "bootstrap"], function (require, exports, bootstrap) {
    ...
    class Toolbar extends HTMLElement {
            ...
            <div class="toolbar">
                ...
                <div id="toolbarEdit">
                    ...
                    <span id="toolbarExt">
                        ...
                        <svg id="btnRotateRight" class="toolbarButton" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Rotate</title><path d="M16.89,15.5L18.31,16.89C19.21,15.73 19.76,14.39 19.93,13H17.91C17.77,13.87 17.43,14.72 16.89,15.5M13,17.9V19.92C14.39,19.75 15.74,19.21 16.9,18.31L15.46,16.87C14.71,17.41 13.87,17.76 13,17.9M19.93,11C19.76,9.61 19.21,8.27 18.31,7.11L16.89,8.53C17.43,9.28 17.77,10.13 17.91,11M15.55,5.55L11,1V4.07C7.06,4.56 4,7.92 4,12C4,16.08 7.05,19.44 11,19.93V17.91C8.16,17.43 6,14.97 6,12C6,9.03 8.16,6.57 11,6.09V10L15.55,5.55Z" /></svg>
        ...
        `;
            ...
            this.btnRemove = this.shadowRoot.getElementById('btnRemove');
            this.btnFitToPage = this.shadowRoot.getElementById('btnFitToPage');
            this.btnCodeEditor = this.shadowRoot.getElementById('btnCodeEditor');
            // this.btnUndo = this.shadowRoot!.getElementById('btnUndo') as any
            // this.btnRedo = this.shadowRoot!.getElementById('btnRedo') as any
            // this.btnCopy = this.shadowRoot!.getElementById('btnCopy') as any
            this.btnProperties = this.shadowRoot.getElementById('btnProperties');
            // this.btnRotateLeft =this.shadowRoot!.getElementById('btnRotateLeft') as any
            this.btnRotateRight = this.shadowRoot.getElementById('btnRotateRight');
            // this.btnMoveDown =this.shadowRoot!.getElementById('btnMoveDown') as any
            // this.btnMoveUp =this.shadowRoot!.getElementById('btnMoveUp') as any
            this.btnMoveToBottom = this.shadowRoot.getElementById('btnMoveToBottom');
            this.btnMoveToTop = this.shadowRoot.getElementById('btnMoveToTop');
            this.currentButton = this.shadowRoot.getElementById('btnPointer');
            const modalElement = document.getElementById('turnoutModal');
            this.turnoutModal = new bootstrap.Modal(modalElement);
            this.turnoutAddress = document.getElementById("turnoutAddress");
            this.turnoutInverted = document.getElementById("turnoutInverted");
            const hiddenDiv = document.getElementById("hiddenDiv");
            // this.btnCopy!.onclick = (e: MouseEvent) => {
            //     const rect = this.btnCopy.getBoundingClientRect();
            //     // Állítsuk be a hiddenDiv pozícióját a toolbarButton bal alsó sarkához
            //     hiddenDiv.style.left = `${rect.left}px`;
            //     hiddenDiv.style.top = `${rect.bottom}px`;
            //     // Váltogassuk a láthatóságot
            //     hiddenDiv.style.display = hiddenDiv.style.display === 'none' || hiddenDiv.style.display === '' 
            //         ? 'block' 
            //         : 'none';
            // }
            document.getElementById("menuItem1").onclick = (e) => {

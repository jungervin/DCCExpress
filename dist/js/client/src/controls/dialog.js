...
// Példa a TabControl hozzáadására a Dialog body részéhez
// const dialog = new Dialog(800, 600, "TabControl Dialog");
// const tabControl = new TabControl();
// const tab1 = tabControl.addTab("Tab 1");
// tab1.getElement().textContent = "Ez az első tab tartalma";
// const tab2 = tabControl.addTab("Loco");
// tab2.getElement().innerHTML = "<h6>Command Center Settings Locomotives<h6>";
// const tab3 = tabControl.addTab("Field");
// tab3.getElement().innerHTML = "<h6>Command Center Settings only turnouts etc. and the Loco Command Center is Different<h6>";
// dialog.addBody(tabControl);
// const combobox = new Combobox([
//     { label: "Select an option", value: "" },
//     { label: "Z21", value: "A" },
//     { label: "DCC-Ex TCP", value: "B" },
//     { label: "DCC-Ex Serial", value: "C" },
// ]);
// combobox.onchange = (sender) => {
//     //locoIp.visible = !locoIp.visible
//     locoIp.visible = locoPort.visible = sender.value == "A" || sender.value == "B"
//     locoSerialPort.visible = sender.value == 'C'
// };
// tab2.addComponent(combobox);
// const locoIp = new Input("IP Address")
// locoIp.visible = false;
// tab2.addComponent(locoIp)
// const locoPort = new Input("Port")
// locoPort.visible = false;
// tab2.addComponent(locoPort)
// const locoSerialPort = new Input("Serial Port")
// locoSerialPort.visible = false;
// tab2.addComponent(locoSerialPort)
// const btnCancel = new Button("Cancel")
// btnCancel.onclick = () => {
//     dialog.close();
// }
